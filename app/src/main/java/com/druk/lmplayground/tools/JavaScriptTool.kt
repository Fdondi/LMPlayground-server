...
class JavaScriptTool(private val context: Context) : Tool {
    ...
    override val description = "Execute JavaScript code and return the result as a string. The value of the last expression is returned."
    override val parametersSchema = """{"type":"object","properties":{"code":{"type":"string","description":"JavaScript code to execute. The last expression's value is returned."}},"required":["code"]}"""
